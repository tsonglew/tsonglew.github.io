---
title: '后端转全平台 06｜性能调优，让 AI 用测量结果证明改进'
...
将原始测量、正确性回归和取舍写入[交付工作簿](/tutorials/backend-to-platform/workbook.md)，再检查最后一页的交付清单。练习包的本地实验、你生成的交互原型和真实线上产品分别验收；后两者中尚未实现的能力继续标明。
