...
export const theme: ThemeUserConfig = {
  ...
  header: {
    menu: [
      ...
      { title: '教程', link: '/blog/backend-to-platform' },
...
export const integ: IntegrationUserConfig = {
  ...
  links: {
    ...
    applyTip: [
      ...
      { name: 'Link', val: 'https://tsonglew.github.io/' },
      { name: 'Avatar', val: 'https://tsonglew.github.io/favicon/favicon.ico' }
    ],
